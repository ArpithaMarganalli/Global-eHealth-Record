        ...
        this._options = $.extend({
          ...
          template: "<div class='popover tour'> " +
              ...
              "<div class='popover-navigation'>" +
                "<button class='btn float-left login_btn' data-role='prev'>&laquo; Prev</button>" +
                "<span data-role='separator' class='float-left'> &nbsp;&nbsp; </span>" +
                "<button class='btn float-left login_btn' data-role='next'>Next &raquo;</button>" +
                "<button class='btn float-right login_btn' data-role='end'>Done</button>" +
              "</div>" +
            "</div>",
